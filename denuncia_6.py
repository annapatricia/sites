...
st.markdown("""
<nav style="display: flex; justify-content: center; background-color: #ffffe0; padding: 10px;">
    <ul style="list-style-type: none; display: flex; justify-content: center; margin: 0; padding: 0;">
        <li style="margin-right: 20px;"><a href="#home" style=text-decoration-style:  dashed, wavy; color: black; font-size: 20px;">Home</a></li>
...
# Seção Home
st.markdown('<h2 id="home" style="text-align: center ; background-color: #ffffe0 ;">Home</h2>', unsafe_allow_html=True)
...
# Seção Sobre Nós
st.markdown('<h2 id="sobre-nos" style="text-align: center ;background-color:#ffffe0;">Sobre Nós</h2>', unsafe_allow_html=True)
...
# Seção Denúncia
st.markdown('<h2 id="denuncia" style="text-align: center ;background-color:#ffffe0;">Denúncia</h2>', unsafe_allow_html=True)
...
nome = st.text_input('Seu Nomeeee')
